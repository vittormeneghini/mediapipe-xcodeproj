...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/thiagovespa/bin/bazel',
    '/private/var/tmp/_bazel_thiagovespa/cc1f6311ebdd0e35719d03ce51a86ecb/execroot/mediapipe',
    'ios_x86_64',
    {
        'macos_x86_64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/thiagovespa/Library/Application Support/Tulsi/0.20190814.88/Bazel',
